...
<%!static Logger logger = LoggerFactory.getLogger("500ErrorPage");%>
<%
    if (exception != null) {
        logger.error("An unexpected error has been occur", exception);
    }
%>
...
<body class="vegas-container" cz-shortcut-listen="true">
	...
	<div id="container">
		...
		<div class="item-title">
			...
			<div id="message">
				...
				<p>And your request couldn't be handled...</p>
	...
	<script src="<c:url value='/assets/js/500.js' />"></script>
