...
public class RedisTokenStore implements TokenStore {
    ...
    public static final String PREFIX                 = "spring:security:oauth:";

    public static final String ACCESS                 = PREFIX + "access:";
    public static final String AUTH_TO_ACCESS         = PREFIX + "auth_to_access:";
    public static final String AUTH                   = PREFIX + "auth:";
    public static final String REFRESH_AUTH           = PREFIX + "refresh_auth:";
    public static final String ACCESS_TO_REFRESH      = PREFIX + "access_to_refresh:";
    public static final String REFRESH                = PREFIX + "refresh:";
    public static final String REFRESH_TO_ACCESS      = PREFIX + "refresh_to_access:";
    public static final String CLIENT_ID_TO_ACCESS    = PREFIX + "client_id_to_access:";
    public static final String UNAME_TO_ACCESS        = PREFIX + "uname_to_access:";
