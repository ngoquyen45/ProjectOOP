...
public class BusinessAssert {
    ...
    /**
     * Assert a boolean expression, throwing {@code BusinessException} if the
     ...
     * 
     * <pre * class="code">
     * BusinessAssert.notEmpty(map, &quot;Map must have entries&quot;);
     * </pre>
     *
     * @param map
     *            the map to check
     ...
     *            the exception message to use if the assertion fails
     * @throws BusinessException
     *             if the collection is {@code null} or has no entries or does
     *             not contain given object
     */
    ...
    public static void contain(Collection<?> collection, Object object) {
        contain(collection, object,
                "[Assertion failed] - this collection must not be empty; it must contain given object");
    }
     ...
     * 
     * <pre class="code">
     * BusinessAssert.equals(expected, actual, BusinessExceptionCode.INVALID_PARAM,
     *         &quot;Expected object must equals with actual object&quot;);
     * </pre>
     * 
     * @param collection
     *            the collection to search
