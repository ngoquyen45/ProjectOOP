...
@RestController(value = "observerReportController")
@RequestMapping(value = "/observer/report")
public class ReportController extends AbstractController {
    ...
    public ResponseEntity<?> getSurveyReport(@RequestParam(required = false) String search,
        ...
        ListDto<SurveyListDto> list = surveyReportService.getSurveys(getUserLogin(), search, getPageRequest(page, size));
        return new Envelope(list).toResponseEntity(HttpStatus.OK);
    }
