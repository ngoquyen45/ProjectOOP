...
@RestController(value = "superAdminImportMasterDataController")
@RequestMapping(value = "/super-admin/import/master-data")
public class ImportMasterDataController extends AbstractController {
    ...
    public ResponseEntity<?> importMasterData(@RequestParam(required = true) String clientId,
