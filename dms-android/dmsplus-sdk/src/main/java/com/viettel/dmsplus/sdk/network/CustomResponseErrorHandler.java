 ...
 * @author Thanh
 * @since 1.0
 * @see org.springframework.web.client.RestTemplate#setErrorHandler
 */
public class CustomResponseErrorHandler implements ResponseErrorHandler {
    ...
    public void handleError(ClientHttpResponse response) throws IOException {
        ...
        switch (statusCode.series()) {
            case CLIENT_ERROR: {
                throw new CustomHttpClientErrorException(statusCode, response.getStatusText(), body, charset, response.getHeaders());
            }
            case SERVER_ERROR:
                throw new CustomHttpServerErrorException(statusCode, response.getStatusText(), body, charset, response.getHeaders());
            default:
