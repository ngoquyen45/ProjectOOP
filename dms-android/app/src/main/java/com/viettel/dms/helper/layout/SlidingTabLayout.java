...
/**
 * Created by PHAMHUNG on 2/27/2015.
 */
...
public class SlidingTabLayout extends HorizontalScrollView {
    ...
    private static final int TAB_VIEW_PADDING_TOP_DIPS = 16;
    private static final int TAB_VIEW_PADDING_LEFT_DIPS = 12;
    ...
    public void setViewPager(ViewPager viewPager, BaseActivity activity) {
    ...
    protected TextView createDefaultTabView(Context context) {
        ...
        textView.setTextSize(TypedValue.COMPLEX_UNIT_SP, getResources().getBoolean(R.bool.is_tablet) ? 14 : TAB_VIEW_TEXT_SIZE_SP);
        ...
        int paddingLeft = (int) (TAB_VIEW_PADDING_LEFT_DIPS * getResources().getDisplayMetrics().density);
    ...
    private void populateTabStrip() {
        ...
        for (int i = 0; i < adapter.getCount(); i++) {
            ...
            tabTitleView.setTextColor(getResources().getColorStateList(R.color.sliding_layout));
