...
/**
 * Created by PHAMHUNG on 3/11/2015.
 */
// reference : http://javapapers.com/android/android-location-fused-provider/
...
public class FusedLocationService implements
    ...
    public FusedLocationService(Context context) {
        ...
        googleApiClient = new GoogleApiClient.Builder(locationContext)
